...
function draw() {
  ...
  sort(
    union([
      sun(1, [255, 200, 120], 190 * details, 5 / details / 4),
      planet(2, -280, 0.3, [0, 255, 0], 50 * details, 30 / details / 4),
      planet(3, -45, 0.3, [0, 255, 255], 50 * details, 30 / details / 4),
      planet(3.7, -140, 0.5, [100, 100, 100], 50 * details, 30 / details / 4),
    ])
